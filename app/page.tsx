  ...
  return (
    <main>
      <nav className="nav shell" aria-label="Main navigation">
        ...
        <div className="nav-links"><a href="#solutions">Solutions</a><a href="#industries">Industries</a><a href="#process">Process</a><a href="#about">Approach</a></div>
      ...
      <section className="contact-section" id="contact"><div className="shell contact-grid"><div><div className="kicker">START A CONVERSATION</div><h2>Ready to automate<br/>your <em>business?</em></h2><p>Book a free consultation and discover how a custom Business Operating System can replace dozens of disconnected tools.</p><div className="contact-points"><span><i>✓</i> 30-minute strategy session</span><span><i>✓</i> No generic sales presentation</span><span><i>✓</i> Clear technical and commercial direction</span></div></div><form><div className="form-row"><label>Name<input name="name" placeholder="Your name" required /></label><label>Company<input name="company" placeholder="Company name" required /></label></div><div className="form-row"><label>Work email<input type="email" name="email" placeholder="you@company.com" required /></label><label>Phone<input type="tel" name="phone" placeholder="+359 ..." /></label></div><label>Tell us about the business<textarea name="description" rows={4} placeholder="What would you like to automate or improve?" required /></label><button type="submit">Book consultation <span>↗</span></button><small>By submitting, you agree to our privacy policy. No spam. Ever.</small></form></div></section>
