...
export const metadata: Metadata = {
  title: "NORTH/OS — Custom Business Operating Systems",
  description: "Enterprise-grade custom business software that unifies operations, finance, CRM, documents, automation, and intelligence.",
};
...
export default function Home() {
  return (
    <main>
      <script type="application/ld+json" dangerouslySetInnerHTML={{__html: JSON.stringify({"@context":"https://schema.org","@type":"ProfessionalService","name":"NORTH/OS","description":"Custom Business Operating Systems and enterprise automation platforms for growing companies.","url":"https://north-business-os.mew-77.chatgpt.site","areaServed":["Netherlands","Denmark","Norway","Sweden","Ireland"],"priceRange":"€5,000–€100,000+","serviceType":["Custom Business Software","CRM Development","ERP Development","Workflow Automation","AI Integration"]})}} />
      ...
      <section className="hero shell" id="top">
        <div className="hero-copy">
          ...
          <div className="hero-note"><span>Built for companies with 10–500+ employees</span><span>Minimum engagement €5,000</span></div>
        </div>
      ...
      <section className="build-section" id="solutions"><div className="shell">
        <div className="section-head dark-head"><div><div className="kicker">02 / WHAT WE BUILD</div><h2>Your business.<br/><em>One intelligent system.</em></h2></div><p>From the first operational bottleneck to an enterprise-wide platform, every module is designed to work as part of one coherent whole.</p></div>
      ...
      <section className="faq-section"><div className="shell faq-grid"><div><div className="kicker">06 / QUESTIONS</div><h2>Before we<br/><em>begin.</em></h2><p>Have a different question?</p><a href="#contact">Talk to a systems architect ↗</a></div><div>{[
        ...
        ["How long does development take?","A focused first release typically takes 6–12 weeks. Larger multi-department platforms are delivered in controlled phases, so you begin seeing value long before the full roadmap is complete."],
      ...
      <section className="contact-section" id="contact"><div className="shell contact-grid"><div><div className="kicker">START A CONVERSATION</div><h2>Ready to automate<br/>your <em>business?</em></h2><p>Book a free consultation and discover how a custom Business Operating System can replace dozens of disconnected tools.</p><div className="project-floor"><small>MINIMUM PROJECT</small><strong>€5,000</strong><span>Focused modules to enterprise-wide platforms. Every engagement starts with a clear business case.</span></div><div className="contact-points"><span><i>✓</i> 30-minute strategy session</span><span><i>✓</i> No generic sales presentation</span><span><i>✓</i> Clear technical and commercial direction</span></div></div><form><div className="form-intro"><span>01</span><div><b>Tell us what you need</b><small>Usually takes less than 2 minutes</small></div></div><div className="form-row"><label>Name<input name="name" placeholder="Your name" required /></label><label>Company<input name="company" placeholder="Company name" required /></label></div><div className="form-row"><label>Work email<input type="email" name="email" placeholder="you@company.com" required /></label><label>Phone<input type="tel" name="phone" placeholder="+31 ..." /></label></div><div className="form-row"><label>Primary service<select name="service" required defaultValue=""><option value="" disabled>Select a service</option><option>Business Operating System</option><option>Custom CRM</option><option>ERP System</option><option>Workflow Automation</option><option>AI Automation</option><option>Client / Employee Portal</option><option>Custom Mobile App</option><option>Not sure yet</option></select></label><label>Company size<select name="company-size" required defaultValue=""><option value="" disabled>Number of employees</option><option>10–25</option><option>26–50</option><option>51–100</option><option>101–250</option><option>251–500</option><option>500+</option></select></label></div><fieldset><legend>Additional features</legend><div className="feature-options">{["CRM & Sales","Employee management","Finance & invoicing","Inventory","Documents","AI assistants","Google Ads","Facebook / Meta","Excel & databases","Mobile app","Custom integrations","Analytics"].map(x=><label key={x}><input type="checkbox" name="features" value={x}/><span>{x}</span></label>)}</div></fieldset><div className="form-row"><label>Investment range<select name="budget" required defaultValue=""><option value="" disabled>Select budget</option><option>€5,000–€10,000</option><option>€10,000–€25,000</option><option>€25,000–€50,000</option><option>€50,000–€100,000</option><option>€100,000+</option></select></label><label>Preferred start<select name="timeline" defaultValue=""><option value="" disabled>Select timeline</option><option>As soon as possible</option><option>Within 1–2 months</option><option>Within 3–6 months</option><option>Exploring for later</option></select></label></div><label>Business challenge<textarea name="description" rows={4} placeholder="What would you like to automate, connect, or improve?" required /></label><button type="submit">Request strategy call <span>↗</span></button><small>Projects start at €5,000. By submitting, you agree to our privacy policy. No spam. Ever.</small></form></div></section>
