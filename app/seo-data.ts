export const SITE_URL = "https://webesign.vercel.app";
...
export const markets = {
  nl: {
    ...
    context:
      "Growing Dutch companies often operate across several entities, international customers and highly connected finance, sales and delivery teams. NORTH/OS creates one operational layer that keeps those workflows visible without forcing the business into a generic SaaS template.",
  ...
  da: {
    ...
    context:
      "Danish companies expect simple digital experiences, dependable integrations and clear ownership of operational data. NORTH/OS brings customer, project, employee, document and finance workflows into one tailored platform designed around how the company already creates value.",
  ...
  no: {
    ...
    context:
      "Norwegian operations frequently combine office teams, field work, suppliers and project-based delivery. NORTH/OS gives leadership one reliable view while employees receive focused tools for the tasks, documents and decisions that belong to their role.",
  ...
  sv: {
    ...
    context:
      "Swedish growth companies need software that supports transparent collaboration without creating another disconnected tool. NORTH/OS unifies customer data, operational work, documents, reporting and automation in a system that can expand across teams and companies.",
...
export const services = {
  "business-automation-software": {
    ...
    intro: "NORTH/OS replaces repetitive administration, disconnected tools and manual handoffs with one operational platform. Rules, responsibilities and data move through the business automatically while management keeps complete visibility and control.",
    ...
    faqs: [
      ...
      ["Does automation replace our current software?", "Only where replacement creates value. NORTH/OS can also connect the systems you want to keep and become the operational layer between them."],
  ...
  "custom-erp-development": {
    ...
    intro: "NORTH/OS creates focused ERP capabilities around the processes that differentiate your company. Orders, purchasing, inventory, projects, resources, delivery and management reporting share one data model without the weight of an oversized generic suite.",
  ...
  "workflow-automation": {
    ...
    faqs: [
      ...
      ["Can workflows span several existing systems?", "Yes. NORTH/OS can coordinate data and actions across CRM, accounting, email, documents, spreadsheets and other API-enabled systems."],
    ],
  },
  "ai-business-automation": {
